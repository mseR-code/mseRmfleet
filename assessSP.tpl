...
//   ...CSAS Res. Doc. YYYY
// Cox, S.P., Kronlund, A.R., and Benson, A.J. 2013. The role of biological
//   and operational reference points...Environmental Cons (2013)
//
// Date Revised:
...
PARAMETER_SECTION
  ...
  init_number lnMsy(ph_msy);
  init_number lnFmsy(ph_fmsy);
  ...
  init_bounded_dev_vector lnOmega(2,nyrs-1,-2.,2.,ph_omega);
  init_number log_init_B_mult(ph_init_B_mult);
